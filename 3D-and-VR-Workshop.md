...
#### Prerequisites
 ...
 - Equipment: VR equipment provided, bring own laptop
 - 
#### Links
Etherpad:
 - Please visit this site and use for sharing notes or commentary during the workshop https://pad.carpentries.org/3dvis
...
### Big Data?
Just like in industry, research data is increasing rapidly in volume, velocity and variety, first in science but now in most fields. 
...
Here we're interested in 3D Visualisation as this is a set of techniques that allows us to produce 3D renderings that can be used on both desktops, handhelds and virtual reality headsets.
...
3) Develop content using a framework that supports VR such as A-Frame, Unity3D, UnrealEngine
 - This is more likely to be done by a programmer who specialises in 3D graphics but these frameworks are getting easier to learn if you are interested and have the time to get really into it! A-Frame in particular is targeted at anyone who knows some web programming techniques.
...
#### Lines
Another very simple data type, useful for linking data objects, drawing map outlines, or tracing positions 
...
- Combining data into more complex visualisations - IPython with WebVR output via LavaVu
...
The Body VR : an example of a polished VR experience with high production values, beyond what we are introducing here but a great example of what can be achieved
...
PreVis - prototype usable but don't use with data you don't want others to have access to. Final version coming soon.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwMzc5NjE3MF19
-->